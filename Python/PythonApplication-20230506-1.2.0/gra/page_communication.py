...
page_title.pack()
tk.Label(page_title, text = "大通讯", font = 30, padx = 30, pady = 30).pack()
...
# 轮播图路径
img_list = ["resource/images/wallpaper.png", "resource/images/WechatPay.png"]
...
ttk.Button(page_category_left, text = "查看", bootstyle = "primary", command = page_category_left_active).pack(padx = 10, pady = (0,10))

page_category_center = ttk.Labelframe(page_category, text = "Club", bootstyle = "info")
tk.Label(page_category_center, text = "社团\n", font = 30, width = width_temp).pack(pady = (20,10))
ttk.Button(page_category_center, text = "查看", bootstyle="primary", command = page_category_center_active).pack(padx = 10, pady = (0,10))

page_category_right = ttk.Labelframe(page_category, text = "Q&A", bootstyle = "info")
tk.Label(page_category_right, text = "凯院问答\n", font = 30, width = width_temp).pack(pady = (20,10))
ttk.Button(page_category_right, text = "查看", bootstyle="primary", command = page_category_right_active).pack(padx = 10, pady = (0,10))
...
label_page_wordcloud = tk.Label(page_wordcloud, text = "\n", font = 30)
